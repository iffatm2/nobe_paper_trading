...
# -*- coding: utf-8 -*-
"""
Created on Sun Oct 11 13:25:58 2020
...
balance, stocks = getCurrentPortfolio()
while True:
    user_input = input("What would you like to do (Search/Buy/Sell/Show/Value/Quit) ")
    ...
    if user_input == "quit":
        ...
        plt.show()
        current_price = stock_wanted.history(period="5d")["Close"][-1]
        print(ticker + "'s" + " current price is $" + str(current_price))

    elif user_input == "buy":
        ticker = input("Enter in what stock you want: ")
        num_shares = int(input("Enter in how many shares you want: "))
